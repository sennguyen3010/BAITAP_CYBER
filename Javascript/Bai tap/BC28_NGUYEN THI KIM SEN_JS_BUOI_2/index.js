...
tongLuong.onclick = function () {
  ...
  var tongLuongFormat = new Intl.NumberFormat('vn-VN').format(tongLuong);
  //output
  document.getElementById('tienLuong').innerHTML =
    'Tiền lương: ' + tongLuongFormat;
};
...
quyDoiTien.onclick = function () {
  ...
  var doiTienFormat = new Intl.NumberFormat('vn-VN').format(tienVnd);

  //output
  document.getElementById('quyDoiVnd').innerHTML =
    'Quy đổi (VND): ' + doiTienFormat;
};
